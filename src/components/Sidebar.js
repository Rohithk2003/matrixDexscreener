...
export default function Sidebar(props) {
    const [sidebar_visible, setvisible] = useState(false)
    useEffect(() => {
    ...
    return (
        <div className={"sidebarwithbutton"}>
            <div className={`sidebar ${sidebar_visible ? "sidebarvisible" : ""}`}>
                <div className={"web-heading"}>
                    ...
                    <div id={"heading"}>nFTify</div>
                    <div className={`${sidebar_visible ? 'close' : ""}`} onClick={() => setvisible(false)}></div>
                </div>
                <div className={"sidebar-button-div"}>
                    <button
                        className={`sidebar-button sidebar-button-text ${props.qtype === 'token' ? 'sidebar-button-selected' : ""}`}
                        data-queryvalue='token'
                        ...
                        <span className={"sidebar-button-text "} data-queryvalue='token'
                              onClick={props.onclick}>Token Address</span>
                    </button>
                    <button
                        className={`sidebar-button sidebar-button-text ${props.qtype === 'pair' ? 'sidebar-button-selected' : ""}`}
                        data-queryvalue='pair' onClick={props.onclick}
                    >
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                             data-queryvalue='token'
                             onClick={props.onclick}>
                        ...
                        <span className={"sidebar-button-text "} data-queryvalue='pair'
                              onClick={props.onclick}>Pair Address</span>
                    </button>
                </div>
                <div className={"sidebar-footer"}>
                    <ul className={"sidebar-footer-data"}>
                        <li>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_32_78)">
                                    <path
            ...
            <div>
                <div id="nav-icon1" className={`${sidebar_visible ? 'open' : ''}`}
                     onClick={() => {
                         setvisible(!sidebar_visible)
                     }}>
                    <span></span>
                    <span></span>
                    <span></span>
